...
class UsersAPI {
  ...
  static changeUserProfile = async (data: UserProfileData) => {
    return await instance.put<string, AxiosResponse>(`/user/profile`, data);
  }

  static changeUserAvatar = async (data: FormData) => {
    return await instance.put<string, AxiosResponse>(`/user/profile/avatar`, data);
  }

  static changeUserPassword = async (data: UserPasswordData) => {
    return await instance.put<string, AxiosResponse>(`/user/password`, data);
  }
