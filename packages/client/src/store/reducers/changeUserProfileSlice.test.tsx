...
describe('changeUserProfileSlice', () => {
    it('should change status with "changeUserProfile.pending" action', async () => {
        const state = changeUserProfileReducer(initialState, actions.changeUserProfile.pending);
    ...
    it('should fetch user with "changeUserProfile.fulfilled" action', () => {
        const state = changeUserProfileReducer(initialState, actions.changeUserProfile.fulfilled(userMock, '', UserProfileDataMock));
    ...
    it('should change status and error with "changeUserProfile.rejected"', () => {
        ...
        const state = changeUserProfileReducer(initialState, action);
